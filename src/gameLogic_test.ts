describe("In Diamond Game", function() {
  ...
  function expectBoardOK(playerNo: number, board: Board): void {
    expect(gameLogic.getInitialBoard(playerNo)).toEqual(board);
  }

  function expectIllegalBoard(playerNo: number): void {
    expect(function() { gameLogic.getInitialBoard(playerNo); }).toThrow();
  }

  function expectIllegalCreateMove(board: Board, turnIndexBeforeMove: number, delta: BoardDelta): void {
    ...
    expectMoveOk(1,
      {board:
        [['#', '#', '#', '#', '#', '#', '#', '#', '#', '', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
         ...
         ['#', '#', '#', '#', '#', '#', '#', '#', 'R', '', 'R', '#', '#', '#', '#', '#', '#', '#', '#'],
         ['#', '#', '#', '#', '#', '#', '#', '#', '#', 'R', '#', '#', '#', '#', '#', '#', '#', '#', '#']],
       delta: {rowS: 9, colS: 12, rowE: 8, colE:12, playerNo: 2}},
      [{setTurn: {turnIndex : 0}},
        {set: {key: 'board', value:
        [['#', '#', '#', '#', '#', '#', '#', '#', '#', '', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
         ['#', '#', '#', '#', '#', '#', '#', '#', '', '', '', '#', '#', '#', '#', '#', '#', '#', '#'],
    ...
    expectIllegalMove(1,
      {board:
        [['#', '#', '#', '#', '#', '#', '#', '#', '#', 'R', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
         ...
         ['#', '#', '#', '#', '#', '#', '#', '#', '', '', '', '#', '#', '#', '#', '#', '#', '#', '#'],
         ['#', '#', '#', '#', '#', '#', '#', '#', '#', '', '#', '#', '#', '#', '#', '#', '#', '#', '#']],
      delta: {rowS: 9, colS: 8, rowE: 9, colE: 6, playerNo: 2}},
      [{setTurn: {turnIndex : 0}},
        {set: {key: 'board', value:
        [['#', '#', '#', '#', '#', '#', '#', '#', '#', 'R', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
         ['#', '#', '#', '#', '#', '#', '#', '#', 'R', '', 'R', '#', '#', '#', '#', '#', '#', '#', '#'],
    ...
    expectMoveOk(0,
      {board:
        [['#', '#', '#', '#', '#', '#', '#', '#', '#', 'R', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
         ...
         ['#', '#', '#', '#', '#', '#', '#', '#', '', '', '', '#', '#', '#', '#', '#', '#', '#', '#'],
         ['#', '#', '#', '#', '#', '#', '#', '#', '#', '', '#', '#', '#', '#', '#', '#', '#', '#', '#']],
      delta: {rowS: 9, colS: 10, rowE: 9, colE: 8, playerNo: 2}},
    ...
    expectMoveOk(1,
      {board:
        [['#', '#', '#', '#', '#', '#', '#', '#', '#', 'R', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
         ...
         ['#', '#', '#', '#', '#', '#', '#', '#', '', '', '', '#', '#', '#', '#', '#', '#', '#', '#'],
         ['#', '#', '#', '#', '#', '#', '#', '#', '#', '', '#', '#', '#', '#', '#', '#', '#', '#', '#']],
      delta: {rowS: 6, colS: 11, rowE: 4, colE: 9, playerNo: 2}},
